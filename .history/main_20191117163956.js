window.paints = [];
var isMobile = /(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i.test(
  navigator.userAgent
);
...
function initPaint(
  ...
  function canvasMove(e) {
    ...
    if (type === 'pen') {
      // 通过压力重置线宽
      canvasContext.lineWidth = config.lineWidth * e.pressure;
  ...
  function canvasUp(e) {
    ...
    canvasEle.removeEventListener('pointermove', canvasMove);
  }
